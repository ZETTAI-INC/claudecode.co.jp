        ...
        <div className="planb-fv__inner">
          <div className="planb-fv__content">
            ...
            <h1 className="planb-fv__heading hidden md:block leading-tight">
              非エンジニアでも、<br />
              <strong className="planb-fv__kenten">14日</strong>でClaude Codeを<br />
              <span style={{ whiteSpace: "nowrap" }}>業務に<strong className="planb-fv__kenten">本番導入</strong>できる。</span>
            </h1>

            {/* Mobile Heading */}
            <h1 className="planb-fv__heading md:hidden leading-[1.6]">
              非エンジニアでも、<br />
              <strong className="planb-fv__kenten">14日</strong>で<br />
              Claude Codeを業務に<br />
              <strong className="planb-fv__kenten">本番導入</strong>できる。
            </h1>
            ...
            <p className="planb-fv__stat-note" style={{
              ...
              プログラミング未経験の社員が、自部署で使う業務ツールを
              <br />
              自分で作り、本番環境で稼働させるまでを14日で完結します。
            </p>
            ...
            <p className="planb-fv__stat-note">※ 自社パイロット研修実績（n=128）／ 14日時点で業務ツールが本番環境で稼働した比率</p>
            ...
            <div className="planb-fv__cta">
              ...
              >
                <span>自社の業務が14日で本番導入できるか、30分で診断する</span>
