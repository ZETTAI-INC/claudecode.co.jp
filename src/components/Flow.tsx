...
const steps: Step[] = [
  ...
  },
  {
    ...
    duration: "60〜90分",
    description:
      "本番導入したい業務、対象部署、受講候補者のスキル、セキュリティ前提を伺い、14日で本番導入できる対象かを一緒に見極めます。オンライン可。",
  },
  {
    number: "03",
    ...
    duration: "1週間以内",
    description:
      "ヒアリング内容をもとに、14日で本番導入まで届くカリキュラムとお見積もりをカスタマイズしてご提示します。",
  },
  {
    number: "04",
    title: "ご契約 & 事前準備",
    duration: "2〜3週間",
    description:
      "契約締結後、本番導入する業務の選定・デプロイ先環境の準備・事前アンケートを進めます。",
  },
  {
    number: "05",
    title: "研修開始",
    duration: "14日間〜",
    description:
      "初日からClaude Codeで本番導入する業務ツールの設計・実装に着手。修了日には1人1本のAIツールが御社の本番環境で稼働している状態になります。",
  },
];
